...
def launch_setup(context, *args, **kwargs):
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([FindPackageShare("ur3_endoscope_description"), "urdf", description_file]),
            " ",
            "robot_ip:=",
            robot_ip,
            " ",
    ...
    static_tf_publisher_camera= Node(
        ...
        arguments=[
                    ...
                    '0',          
                    '0',         
                    '3.66519',          #30 gradi in radianti per puntare a dove vede la camera.
                    'wrist_3_link',
                    'camera'  
        ]
    )
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="ur3_endoscope.urdf.xacro",
